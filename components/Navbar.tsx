  ...
  return (
    <div className="pointer-events-none fixed top-4 inset-x-0 z-50 flex justify-center px-4">
      ...
      <div className="pointer-events-auto relative flex h-14 w-full items-center justify-between rounded-full border border-white/[0.08] bg-[#0B0F17]/85 px-5 shadow-[0_8px_32px_rgba(0,0,0,0.6)] backdrop-blur-xl">
        ...
        {/* Center — absolute for true X centering */}
        <nav
        ...
        <div className="flex min-w-0 items-center justify-end gap-2 sm:min-w-[200px] sm:gap-3">
          <Link
            href="/docs"
            className="hidden items-center gap-1.5 text-xs font-medium text-slate-400 transition hover:text-white md:inline-flex focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500/50"
          >
          ...
          <Link
            href="/dashboard"
            className="hidden items-center gap-1.5 rounded-full bg-emerald-500 px-4 py-2 text-xs font-semibold text-black shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all hover:bg-emerald-400 sm:inline-flex focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500/50"
          >
            Launch Console
      ...
      {open ? (
        <div className="pointer-events-auto absolute top-[calc(100%+0.5rem)] left-4 right-4 mx-auto max-w-6xl rounded-2xl border border-white/[0.08] bg-[#0B0F17]/95 p-4 shadow-[0_8px_32px_rgba(0,0,0,0.6)] backdrop-blur-xl lg:hidden">
